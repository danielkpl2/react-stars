...
class Starlist extends Component {
	...
	render() {
		const { stars, currentStarIndex, loadingSearch, error } = this.props;
						...
						<div className="wrapper-left">
							<div className="inner-left" id="inner-left">
								...
								<Table id="stars-table" striped bordered hover variant="dark" style={{ width: "516px", borderSpacing: "0" }}>
									...
									<tbody>
										{stars.map((value, key) =>
											<tr onMouseEnter={this.onMouseEnter} key={key} className={currentStarIndex === key ? "table-active" : ""} onClick={() => this.props.handleStarClick(key)}>
